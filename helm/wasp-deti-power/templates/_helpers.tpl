...
*/}}
{{- define "wasp-deti-power.fullname" -}}
...
Selector labels
*/}}
{{- define "wasp-deti-power.selectorLabels" -}}
app.kubernetes.io/name: {{ include "wasp-deti-power.fullname" . }}
{{- end }}

{{/*
Common labels
*/}}
{{- define "wasp-deti-power.labels" -}}
helm.sh/chart: {{ include "wasp-deti-power.chart" . }}
{{ include "wasp-deti-power.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
*/}}
{{- define "wasp-deti-power.imagePullSecrets" -}}
...
*/}}
{{- define "wasp-deti-power.thing-service-name" -}}
...
*/}}
{{- define "wasp-deti-power.init.payload-topic.name" -}}
...
*/}}
{{- define "wasp-deti-power.kafka.brokers" -}}
...
*/}}
{{- define "wasp-deti-power.init.thingType" }}
{{ $name := include "wasp-deti-power.fullname" . }}
- name: {{ printf "%s-wait-deps" $name | trunc 63 | trimSuffix "-" }}
  ...
  env:
    - name: THING_NAME
      value: {{ include "wasp-deti-power.thing-service-name" . }}
...
{{- define "wasp-deti-power.init.kafkaTopics" }}
- name: {{ include "wasp-deti-power.init.payload-topic.name" . }}
